...
-- Notice that INNER JOIN misses the teacher with no department and the
...
-- Use a differnt JOIN so that all departments are listed.
...
-- Use CASE to show the name of each teacher followed by 'Sci' if the teacher
-- is in dept 1 or 2, show 'Art' if the teacher's dept is 3 and 'None'
-- otherwise.
